...
import com.levup.mylibrary.ConvertedCurrency;
import com.levup.mylibrary.ItemListener;
...
//    EditText tv3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConvertedCurrency convertedCurrency = new ConvertedCurrency(getBaseContext());
        convertedCurrency.addCurrency(element -> {
            Log.d("TAG","add " + element.toString());
        });

        convertedCurrency.removeCurrency(element -> {
            Log.d("TAG","remove " + element.toString());
        });

        convertedCurrency.setList(new ArrayList<>());


        mySpinner = new MySpinner(this);


        String s = getResources().getString(R.string.CHAT_MESSAGE_NOTIFICATION_BODY, "1", "2");
